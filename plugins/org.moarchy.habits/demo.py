...
claim habits makes about being a port rather than a rewrite -- so the fixture
...
describing a file format nothing writes any more.
    ...
    MOARCHY_HABITS_DIR=/tmp/habits plugins/org.moarchy.habits/demo.py
"""
...
GTK = Path(__file__).resolve().parents[2] / "apps" / "habits" / "demo.py"
