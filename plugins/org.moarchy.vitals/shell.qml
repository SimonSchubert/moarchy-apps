// Vitals as its own Quickshell process, for a system without omarchy-shell.
//
//   quickshell -p plugins/org.moarchy.vitals/shell.qml
//
// Inside the shell this file is never read: the plugin host instantiates
// Vitals.qml itself, keeps it loaded, and decides when the window is up. Here
...
ShellRoot {
  ...
  // MOARCHY_VITALS_QUIT_AFTER=6 -- the check harness's clock, for the reason the
