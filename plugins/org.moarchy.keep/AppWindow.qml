...
//
// Copied into this plugin rather than imported from moarchy.common: a
...
// truth for why this is a FloatingWindow and not a layer surface -- Keep
// has text fields, and a layer Overlay draws over the on-screen keyboard.
import QtQuick
import Quickshell
