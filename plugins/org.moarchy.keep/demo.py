...
claim keep makes about being a port rather than a rewrite -- so the fixture
...
describing a file format nothing writes any more.
    ...
    MOARCHY_KEEP_DIR=/tmp/keep plugins/org.moarchy.keep/demo.py
"""
...
GTK = Path(__file__).resolve().parents[2] / "apps" / "keep" / "demo.py"
