#!/bin/bash
# Copy Clock onto the phone, with shared/qs_ui vendored as ui/.
#
...
scp "$ROOT/icon.svg" "$PHONE:.local/share/icons/hicolor/scalable/apps/org.moarchy.Clock.svg"
scp "$ROOT/org.moarchy.Clock.plugin.desktop" \
  "$PHONE:.local/share/applications/org.moarchy.Clock.plugin.desktop"
