...
claim launches makes about being a port rather than a rewrite -- so the fixture
...
describing a file format nothing writes any more.
    ...
    MOARCHY_LAUNCHES_DIR=/tmp/launches plugins/org.moarchy.launches/demo.py
"""
...
GTK = Path(__file__).resolve().parents[2] / "apps" / "launches" / "demo.py"
