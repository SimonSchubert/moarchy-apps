...
from .window import BreakoutWindow  # noqa: E402

APP_ID = "org.moarchy.Breakout"
...
class BreakoutApplication(Adw.Application):
    ...
    def do_activate(self) -> None:
        ...
        if window is None:
            window = BreakoutWindow(self.store, application=self)
        ...
        seconds = os.environ.get("MOARCHY_BREAKOUT_QUIT_AFTER")
    ...
    def do_shutdown(self) -> None:
        ...
        try:
            ...
            print(f"moarchy-breakout: could not save the game: {exc}", file=sys.stderr)
    ...
    def _on_about(self, *_args) -> None:
        about = Adw.AboutDialog(
            ...
            comments=(
                "Breakout for a Linux phone. The bat follows your thumb from "
                "anywhere on the field, the wall is your theme's colours, and "
                "the frame loop stops the moment the window does."
            ),
        )
...
def main() -> int:
    return BreakoutApplication().run(sys.argv)
