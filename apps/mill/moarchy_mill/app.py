...
from .window import MillWindow  # noqa: E402

APP_ID = "org.moarchy.Mill"
...
class MillApplication(Adw.Application):
    ...
    def do_activate(self) -> None:
        ...
        if window is None:
            window = MillWindow(self.store, application=self)
        ...
        seconds = os.environ.get("MOARCHY_MILL_QUIT_AFTER")
    ...
    def do_shutdown(self) -> None:
        ...
        try:
            ...
            print(f"moarchy-mill: could not save the game: {exc}", file=sys.stderr)
    ...
    def _on_about(self, *_args) -> None:
        about = Adw.AboutDialog(
            ...
            comments=(
                "Nine Men's Morris for a Linux phone. One tap while there is a "
                "piece in your hand and two once there is not, an opponent that "
                "thinks on a clock, and the board in your theme's colours."
            ),
        )
...
def main() -> int:
    return MillApplication().run(sys.argv)
